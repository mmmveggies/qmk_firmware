...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, LAYER_1, L5_ESC , L4_SPC , L4_SPC , KC_BSPC, KC_BSPC, KC_ENT , LAYER_2, XXXXXXX, XXXXXXX
  ),
  ...
  [5] = LAYOUT_planck_grid(
    KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , XXXXXXX, XXXXXXX, KC_6   , KC_7   , KC_8   , KC_9   , KC_0   ,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, L3_R1  , L3_R2  , L3_R3  , L3_R4  ,
